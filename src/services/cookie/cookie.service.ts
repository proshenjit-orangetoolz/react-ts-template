class CookieService {
    ...
    setCookie(cname: string | undefined, cvalue: string, exTime: string) {
        const d = new Date();
    ...
    getCookie(cname: string | undefined) {
        const name = cname + '=';
    ...
    checkCookie = (cname: string | undefined) => {
